...
async def parse_blog_sections(form_data) -> List[BlogSection]:
    """Parse sections from JSON string and section_images files (multiple images per section)"""
    ...
    for i, section_data in enumerate(sections_data):
        ...
        # Collect all images for this section
        section_image_urls = []
        image_files = form_data.getlist(f'section_images[{i}][]')
